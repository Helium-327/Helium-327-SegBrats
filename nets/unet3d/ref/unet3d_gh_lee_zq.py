...
'''
================================================
*      CREATE ON: 2024/09/27 19:54:08
*      AUTHOR: @Junyin Xiong
*      DESCRIPTION: 代码来源 :https://github.com/lee-zq/3DUNet-Pytorch/blob/master/models/UNet.py
=================================================
'''
...
class UNet_gh1(nn.Module):  

    def __init__(self, in_channel=1, out_channel=2, training=True):
        super(UNet_gh1, self).__init__()
