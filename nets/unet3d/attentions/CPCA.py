...
'''
================================================
*      CREATE ON: 2024/10/18 21:31:12
*      AUTHOR: @Junyin Xiong
*      DESCRIPTION: CPCA注意力 模块 （通道注意力） #TODO:待修改
=================================================
#! CPCA（Channel Prior Convolutional Attention）注意力机制是一种用于增强特征表示和动态分配注意力权重的方法。\
#! 它结合了通道注意力和空间注意力，通过多尺度深度可分离卷积模块有效地提取空间关系并保留通道先验。
#! CPCA具备聚焦信息丰富通道和重要区域的能力，从而提高模型的性能。
'''
