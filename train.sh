...
# python main.py --epochs 300 --data_scale full --model f_cac_unet3d --early_stop_patience 30 --nw 4 --bs 2 --cosine_T_max 300 --commit 'fully trainging on fixbug f_cac_unet3d' 
...
python main.py --epochs 300 --data_scale full --model rid_unet3d --early_stop_patience 30 --nw 4 --bs 1 --cosine_T_max 300 --commit 'fully trainging on fixbug rid_unet3d' 
# python main.py --epochs 300 --data_scale full --model up_cac_unet3d --early_stop_patience 30 --nw 4 --bs 2 --cosine_T_max 300 --commit 'fully trainging on up_cac_unet3d' 
# python main.py --epochs 300 --data_scale full --model down_cac_unet3d --early_stop_patience 30 --nw 4 --bs 2 --cosine_T_max 300 --commit 'fully trainging on down_cac_unet3d' 
